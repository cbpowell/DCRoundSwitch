...
- (void)drawInContext:(CGContextRef)context
{
	...
	CGContextSetShadowWithColor(context, CGSizeMake(0.0, 1), 2.0, [UIColor colorWithRed:0.1 green:0.1 blue:0.1 alpha:0.4].CGColor);
	CGContextSetLineWidth(context, 1.0);
	UIBezierPath *outlinePath = [UIBezierPath bezierPathWithRoundedRect:self.bounds cornerRadius:self.bounds.size.height / 2.0];
	CGContextAddPath(context, outlinePath.CGPath);
	CGContextSetStrokeColorWithColor(context, [UIColor colorWithWhite:0.00 alpha:1.0].CGColor);
